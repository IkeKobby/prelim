...
\usepackage{lipsum}
\usepackage{tikz}
\usetikzlibrary{tikzmark,arrows.meta,positioning,calc}
...
\begin{frame}{CAAFE: Problem Setup}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{img/context_info.png}
...
\begin{frame}{CAAFE: Methodology}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{img/trad_autoML.png}
        \caption{CAAFE LLM semantic capabilities with traditional ML}
    \end{figure}
...
\begin{frame}{CAAFE: Methodology}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{img/caafe-work-iter.png}
        \caption{CAAFE iterative workflow}
    \end{figure}
\end{frame}
...
\begin{frame}{Three Evaluation Dimensions}
    ...
    \begin{columns}
        ...
        \textbf{Examples:}
        \begin{itemize}
            \item Phi-2 (2.7B): Commonsense reasoning and code generation on par with 30B models, 15× faster
            \item Phi-3 (7B): Language understanding and commonsense reasoning on par with 70B models
            \item Nemotron-H (2-9B): Instruction following and code generation comparable to 30B LLMs, order-of-magnitude fewer FLOPs
        \end{itemize}
...
\begin{frame}{Empirical Evidence}
    \begin{table}
        ...
        Phi-2 & 2.7B & Commonsense reasoning, code generation on par with 30B, 15× faster \\
        Phi-3 & 7B & Language understanding, commonsense reasoning on par with 70B \\
        Nemotron-H & 2-9B & Instruction following, code generation comparable to 30B, order-of-magnitude fewer FLOPs \\
        \bottomrule
        \end{tabular}
...
\begin{frame}{MiniCPM: Key Takeaways}
    ...
    \vspace{0.5cm}
    \begin{block}{Connection to My Research}
    Provides systematic methodology for optimizing SLM training and deployment strategies, directly applicable to domain-specific SLM development and deployment
    \end{block}
\end{frame}
...
\begin{frame}{Overall Research Objectives}
    \includegraphics[width=\textwidth]{img/research_plan_overview.png}
\end{frame}
...
\begin{frame}{Overall Research Objectives}
    ...
    \begin{itemize}
        ...
        \item Demonstrate scalable deployment patterns with privacy-preserving capabilities
    \end{itemize}
    \end{block}
...
\begin{frame}{Project 1: SLM-First Automated Feature Engineering}
    \begin{columns}
        ...
        \vspace{0.3cm}
        \textbf{Evaluation:} CAAFE evaluation datasets (OpenML: airlines, balance-scale, breast-w, cmc, credit-g, diabetes, eucalyptus, jungle\_chess, pc1, tic-tac-toe; Kaggle: health-insurance, pharyngitis, kidney-stone, spaceship-titanic) plus additional synthetic datasets; compare against DFS/AutoFeat and LLM-based CAAFE
...
\begin{frame}{Research Contributions}
    ...
    \begin{itemize}
        \item Privacy-sensitive data processing (on-premise deployment)
        \item Resource-constrained environments (edge computing)
        \item Cost-sensitive production deployments
    \end{itemize}
    \end{block}
\end{frame}
