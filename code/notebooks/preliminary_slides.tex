...
\begin{frame}{WSD Learning Rate Scheduler}
    ...
    \column{0.5\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width = \textwidth]{img/wsd.png}
...
\begin{frame}{Overall Research Objectives}
    \includegraphics[width=12cm, height = 7cm]{img/plan2.png}
\end{frame}
...
\begin{frame}{Project 1: SLM-First Automated Feature Engineering}
    % \begin{columns}
        ...
        \begin{figure}
            \centering
            \includegraphics[width = \textwidth]{img/SLM-first-CAAFE.png}
...
\begin{frame}{Project 1: SLM-First Automated Feature Engineering}
    \begin{columns}
        ...
        \column{0.5\textwidth}
        \vspace{0.3cm}
        \textbf{Evaluation:} Evaluation datasets (e.g. OpenML: airlines, balance-scale, breast-w, cmc, credit-g, diabetes, eucalyptus, jungle\_chess, pc1, tic-tac-toe; Kaggle: health-insurance, pharyngitis, kidney-stone, spaceship-titanic) plus additional synthetic datasets; compare against DFS/AutoFeat and LLM-based CAAFE
...
\begin{frame}{Project 2: SLM-First Case-Based Reasoning}
        ...
        \begin{figure}
            \centering
            \includegraphics[width = 12cm,,height = 7cm]{img/cbr.png}
...
\begin{frame}{Project 3: SLM-Powered Multi-Agent AutoML}
        \begin{figure}
            \centering
            \includegraphics[width = 13cm, height = 7cm]{img/multi-agent.png}
